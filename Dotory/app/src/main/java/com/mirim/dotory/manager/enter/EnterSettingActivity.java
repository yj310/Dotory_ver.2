...
public class EnterSettingActivity extends AppCompatActivity {
    ...
    private void createAddEnterTimePopup() {
        Dialog dialog = new Dialog(EnterSettingActivity.this);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if( (start_hour < end_hour) || ((start_hour==end_hour)&&(start_minute < end_hour)) ) {
                    ...
                    DatabaseReference databaseReference = database.getReference("Enter/timeList/lastkey");
                    databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            dialog.cancel();
                            Toast.makeText(EnterSettingActivity.this, "추가가 완료되었습니다. ", Toast.LENGTH_SHORT).show();
                            reloadPage();
                        }
                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            // DB를 가져오던 중 에러 발생 시
                            Toast.makeText(EnterSettingActivity.this, error.toException().toString(), Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    Toast.makeText(EnterSettingActivity.this, "시간 설정이 옳바르지 않습니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        btn_set_start.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(add_popup_select_state.equals("end")) {
                    // 화면이 변경되었다면
                    add_popup_select_state = "start";
                    btn_set_start.setTextColor(ContextCompat.getColor(EnterSettingActivity.this, R.color.colorBasic));
                    btn_set_end.setTextColor(ContextCompat.getColor(EnterSettingActivity.this, R.color.colorTextBlur));
                    end_hour = timePicker.getHour();
                    end_minute = timePicker.getMinute();
        ...
        btn_set_end.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(add_popup_select_state.equals("start")) {
                    ...
                    btn_set_start.setTextColor(ContextCompat.getColor(EnterSettingActivity.this, R.color.colorTextBlur));
                    btn_set_end.setTextColor(ContextCompat.getColor(EnterSettingActivity.this, R.color.colorBasic));
                    start_hour = timePicker.getHour();
                    start_minute = timePicker.getMinute();
    ...
    private void createMorePopup(View view) {
        PopupMenu popup = new PopupMenu(EnterSettingActivity.this, view);
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if(item.getTitle().equals("삭제")){
                    Intent popupIntent = new Intent(EnterSettingActivity.this, DeleteEnterTimeActivity.class);
    ...
    private void setRecyclerView() {
        ...
        adapter = new EnterTimeCustomAdapter(arrayList, this, this);
